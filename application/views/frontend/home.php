		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-end">
				<div class="banner-content col-lg-7 col-md-12">
					...
					<p class="text-white">
						Sekarang cari tiket bus semakin mudah, bisa pesan online di Tiket Bus ALMASAR. Tak perlu repot
						ke terminal atau kantor agen, sekarang Anda bisa beli tiket dengan mudah. Booking Cepat dan
						Mudah. Bebas Pilih Kursi. Termurah Setiap Hari. Customer Service 24/7. Semua Kelas dan Rute.
					</p>
		...
		<div class="container">
			<div class="row d-flex justify-content-center">
				<div class="col-md-8 pb-40 header-text">
					<h1>LANGKAH-LANGKAH MEMESAN TIKET BUS</h1>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-service">
						...
						<p>
							Pilih bus, tempat duduk, tempat keberangkatan, tujuan, isi detail penumpang dan klik
							'Pembayaran'
						</p>
					</div>
				</div>
