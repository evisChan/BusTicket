					...
					<div class="card card-login mx-auto mt-10">
						...
						<div class="card-body" align="left">
							...
							<div class="text-center">
								<p><a class="d-block mt-3" href="<?php echo base_url() ?>login/daftar"> Daftar
										Sekarang</a>
									<hr>
									<b><a class="d-block mt-3" style="font-size:15px;"
											href="<?php echo base_url() ?>backend/login">Login sebagai Admin</a></b>
