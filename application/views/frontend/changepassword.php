								...
								<form ction="<?php echo base_url('profile/changepassword') ?>" method="post">
									...
									<div class="form-group">
										<div class="form-label md-5">
											<input type="password" class="form-control" required="" name="new_password1"
									...
									<div class="form-group">
										<div class="form-label md-5">
											<input type="password" class="form-control" required="" name="new_password2"
												placeholder="Ulangi Password">
										</div>
									</div>
									<a class="btn btn-danger"
										href="<?php echo base_url() ?>profile/profilesaya/<?php echo $this->session->userdata('kd_pelanggan') ?>">Kembali</a>
