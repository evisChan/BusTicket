		...
		<div class="row">
			<div class="col-lg-3  col-md-6 col-sm-6">
				<div class="single-footer-widget">
					...
					<p>
						BUS Tickets is the largest online bus ticket booking service in the world. Trusted by more than
						8 million customers globally. Bus Tickets offers booking bus tickets through the website.
					</p>
				</div>
			</div>
						...
						<form class="navbar-form" novalidate="true" action="" method="post">
							<div class="input-group add-on">
								...
								<div class="input-group-btn">
									<button class="genric-btn primary circle arrow"><span
