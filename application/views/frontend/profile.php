							...
							<div class="card-body" align="left">
								<div class="row">
									<div class="col-sm-8">
										...
										<p class="card-text">
											<?php echo $profile['no_ktp_pelanggan'] ?>
										</p>
										<h5 class="card-title">Nama</h5>
										<p class="card-text">
											<?php echo $profile['nama_pelanggan'] ?>
										</p>
										<h5 class="card-title">Email</h5>
										<p class="card-text">
											<?php echo $profile['email_pelanggan'] ?>
										</p>
										<h5 class="card-title">No Telpon</h5>
										<p class="card-text">
											<?php echo $profile['telpon_pelanggan'] ?>
										</p>
									</div>
									<div class="col-sm-14">
										<h5 class="card-title">Alamat</h5>
										<p class="card-text">
											<?php echo $profile['alamat_pelanggan'] ?>
										</p>
