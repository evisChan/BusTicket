					...
					<div class="card ">
						...
						<div class="card-body">
										...
										<div class="col-md-6">
											<div class="form-label-group">
												<input type="number" id="nomor" name="nomor" class="form-control"
													required="" placeholder="Nomor Telpon"
													value="<?php echo set_value('nomor') ?>">
								...
								<div class="form-group">
									...
									<div class="form-label-group">
										<textarea class="form-control"
											name="alamat"><?php echo set_value('alamat') ?></textarea>
							...
							<div class="text-center">
								<p>Sudah Daftar? <a class="" href="<?php echo base_url() ?>login">Login Sekarang</a>
								</p>
							</div>
						</div>
					</div>
