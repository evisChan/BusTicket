			...
			<div class="row">
				...
				<div class="col-lg-4">
					<form action="<?php echo base_url('tiket/afterbeli') ?>" method="get">
						...
						<div class="card mb-5">
							<div class="card-header">
								<i class="fas fa-bus"></i> Pilih Tempat duduk
							</div>
							<center class="">
								<table class="">
									<tr>
										...
										<td class='btn-group' width='139'>
											...
											<label class='btn btn-primary'>
												<a value='' autocomplete='off' disabled='disabled'>Pengemudi</a>
											</label>
										</td>
									</tr>
									<tr>
				...
				<div class="col-lg-4">
					...
					<div class="card mb-5">
						<div class="card-header">
							<i class="fas fa-bookmark"></i> Konfirmasi Pesanan
						</div>
