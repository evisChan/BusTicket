						...
						foreach($kursi as $row) { ?>
							<div class="card mb-5">
								<div class="card-header">
									<i class="fas fa-id-card"></i> Nomor Kursi
									<?php echo $row; ?>
								</div>
								<div class="card-body">
									<div class="form-group">
										...
										<input type="text" id="" class="form-control" id="" name="nama[]"
											placeholder="Nama Penumpang <?php echo $row ?>" required>
							...
							<div class='form-group'>
								<div class='col-sm-12'>
									<input name='no_ktp' required="" maxlength='64' class='form-control required'
										placeholder='No KTP' type='text' title='ID number must be filled.'
										value="<?php echo $this->session->userdata('ktp') ?>">
								</div>
							</div>
							<div class='form-group'>
								<div class='col-sm-12'>
							...
							<div class='form-group'>
								<div class='col-sm-12'>
									<input name='hp' required="" maxlength='16' class='form-control required'
										...
										value="<?php echo $this->session->userdata('telpon') ?>">
								</div>
							</div>
							<div class='form-group'>
								<div class='col-sm-12'>
									<textarea name='alamat' cols='20' rows='3' id='alamat' required="" maxlength='256'
										...
										title='Address Required.'><?php echo $this->session->userdata('alamat') ?></textarea>
								</div>
							</div>
							<div class='form-group'>
								<div class='col-sm-12'>
						...
						<div class="card-body">
							<form action="<?php echo base_url() ?>tiket/cektiketmu" method="post">
								...
								<div class='form-group'>
									...
									<button class="btn btn-success pull-right">Proses Tiket</button>
								</div>
							</form>
							<!-- Log on to codeastro.com for more projects -->
						</div>
