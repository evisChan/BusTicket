            ...
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><a
                    href="<?= base_url('backend/tiket') ?>">Total Tiket Terjual</a></div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">
                  <?= $tiket[0]['count(kd_tiket)']; ?>
                </div>
              </div>
              <div class="col-auto">
            ...
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-danger text-uppercase mb-1"><a
                    href="<?= base_url('backend/konfirmasi') ?>">Daftar Pembayaran</a></div>
                <div class="row no-gutters align-items-center">
                  <div class="col-auto">
                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                      <?= $konfirmasi[0]['count(kd_konfirmasi)']; ?>
                    </div>
                  </div>
                  <div class="col">
        ...
        <div class="card border-left-info shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><a
                    href="<?= base_url('backend/rute') ?>">Total terminal</a></div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">
                  <?= $terminal[0]['count(kd_tujuan)']; ?>
                </div>
              </div>
              <div class="col-auto">
            ...
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><a
                    href="<?= base_url('backend/bus') ?>">Bus yang Tersedia</a></div>
                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                  <?= $bus[0]['count(kd_bus)']; ?>
                </div>
              </div>
