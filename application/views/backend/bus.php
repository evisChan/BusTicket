...
<body id="page-top">
  ...
  <div class="container-fluid">
    <h1 class="h5 text-gray-800">Manajemen Bus </h1>
    <!-- DataTales Example -->
            ...
            <tbody>
              ...
              foreach ($bus as $row) { ?>
                <tr>
                  ...
                  <td>
                    <?= strtoupper($row['kd_bus']); ?>
                  </td>
                  <td>
                    <?= strtoupper($row['nama_bus']); ?>
                  </td>
                  <td>
                    <?= strtoupper($row['plat_bus']); ?>
                  </td>
                  <td>
                    <?= $row['kapasitas_bus'] ?>
                  </td>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tambahkan Bus</h5>
        ...
        <div class="modal-body">
          <form action="<?= base_url() ?>backend/bus/tambahbus" method="post">
            ...
            <div class="form-group">
              <label for="platbus" class="">Nomor Plat Bus</label>
              <input type="text" class="form-control" name="plat_bus" placeholder="Plat Bus">
            </div>
            <div class="form-group">
              <label for="seat" class="">Nomor kursi (Max.19)</label>
