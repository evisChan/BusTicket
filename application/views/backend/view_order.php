  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Kode Pesanan [
          <?= $tiket[0]['kd_order']; ?>]
        </h6>
      </div>
      <div class="card-body">
              ...
              <?php foreach ($tiket as $row) { ?>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="nama[]" value="<?= $row['nama_kursi_order'] ?>"
                        readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                    <label for="" class="col-sm-4 control-label">No kursi</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="no_kursi[]" value="<?= $row['no_kursi_order'] ?>"
                        readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="harga" value="<?php echo $row['harga_jadwal']; ?>"
                        readonly>
                    </div>
                  </div>
                  <div class="row form-group">
                ...
                <div class="row form-group">
                  <div class="alert alert-warning" role="alert">
                    <h4 class="alert-heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      ...
                      </svg>Cek konfirmasi Pembayaran!!</h4>
                    <p>Di sini Anda dapat memeriksa konfirmasi pembayaran pelanggan. Cukup klik tombol lihat untuk
                      melihat
              ...
              <div class="col-sm-6">
                <div class="row form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <?php } else { ?>
                      <p class="btn"><b class="btn btn-outline-warning">Batalkan</b></p>
                    <?php } ?>
