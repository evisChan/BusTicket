    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="card-body">
          <div class="row">
            <div class="col-sm-12">
              <form action="<?= base_url() ?>backend/jadwal/tambahjadwal" method="post">
                <div class="form-group">
                  ...
                  <select class="form-control" name="asal" required>
                    ...
                    <?php foreach($tujuan as $row) { ?>
                      <option value="<?= $row['kd_tujuan'] ?>">
                        <?= strtoupper($row['kota_tujuan'])." - ".$row['terminal_tujuan']; ?>
                      </option>
                    <?php } ?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  <label class="">Waktu Keberangkatan</label>
                  <input type="text" class="form-control" id="time" name="berangkat" required=""
                    placeholder="waktu Keberangkatan">
                </div>
                <div class="form-group">
                  <label class="">Waktu Kedatangan</label>
                  <input type="text" class="form-control" id="time2" name="tiba" required=""
          ...
          <input type="submit" class="btn btn-success pull-rigth" value="tambahkan jadwal">
          </form>
        </div>
      </div>
    </div>
