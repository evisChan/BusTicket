  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h1 class="h5 text-gray-800">Daftar Pesanan</h1>
      </div>
      <div class="card-body">
            ...
            <tbody>
              ...
              foreach($order as $row) { ?>
                <tr>
                  ...
                  <td>
                    <?= hari_indo(date('N', strtotime($row['tgl_berangkat_order']))).', '.tanggal_indo(date('Y-m-d', strtotime(''.$row['tgl_berangkat_order'].''))); ?>
                  </td>
                  <td>
                    <?= $row['nama_order']; ?>
                  </td>
                  ...
                  <?php } ?>
                  <td><a href="<?= base_url('backend/order/vieworder/'.$row['kd_order']) ?>"
