...
<body id="page-top">
  ...
  <div class="container-fluid">
    <h1 class="h5 text-gray-800">Tujuan/Manajemen Terminal </h1>
    <!-- DataTales Example -->
            ...
            <tbody>
              ...
              foreach($tujuan as $row) { ?>
                <tr>
                  ...
                  <td>
                    <?= substr($row['terminal_tujuan'], 0, 15); ?>
                  </td>
                  <td align="center"><a href="<?= base_url('backend/rute/viewrute/'.$row['kd_tujuan']) ?>"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= base_url() ?>backend/rute/tambahtujuan" method="post">
            ...
            <div class="form-group">
              <div class="form-label-group">
                <input type="text" id="terminal" name="terminal" class="form-control" placeholder="Info Terminal"
                  required="required" autofocus="autofocus">
              </div>
            </div>
